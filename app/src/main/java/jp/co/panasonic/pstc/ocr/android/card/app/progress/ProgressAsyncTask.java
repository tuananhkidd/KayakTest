...
//        	// 特に何もしない
//			Log.d("ProgressAsyncTask", "doInBackground() uoe");
//		}

//		Log.d("ProgressAsyncTask", "doInBackground() before");
//		// カウントアップ完了まで待機
//        while( counter.getCount() < progressMaxCount ){
//			Log.d("ProgressAsyncTask", "doInBackground() " + counter.getCount() + "  " + progressMaxCount);
//		}
//		Log.d("ProgressAsyncTask", "doInBackground() after");
//
//		// カウントアップスレッド終了
//        try {
//        	counter.stop();
...
//
    ...
    protected void onCancelled() {
        super.onCancelled();
        Log.d("ProgressAsyncTask", "onCancelled()");
    ...
    protected void onPostExecute(Object result) {
        ...
        handler.post(new Runnable() {
            public void run() {
                Log.d("ProgressAsyncTask", "onPostExecute()  Runnable");
    ...
    class CountUpThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                ...
                // 待機(ミリ秒)
                try {
                    Thread.sleep(progressCountUpMills);
